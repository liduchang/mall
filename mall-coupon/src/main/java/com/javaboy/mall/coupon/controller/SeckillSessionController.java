...
import com.javaboy.mall.coupon.service.SeckillSessionService;
...
public class SeckillSessionController {
    ...
    public Resp info(@PathVariable("id") Long id){
        ...
        return Resp.ok().put("seckillSession", seckillSession);
    }
    ...
    public Resp save(@RequestBody SeckillSessionEntity seckillSession){
    ...
    public Resp update(@RequestBody SeckillSessionEntity seckillSession){
